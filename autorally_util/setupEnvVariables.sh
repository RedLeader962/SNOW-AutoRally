...
echo "$0 | step 1: Get list of devices and locate config folder" # TODO: remove line when done
...
echo "$0 | step 2: setup servo controller and determine chassis" # TODO: remove line when done

if [[ $devList == *"arChassis"* ]]; then # If Arduino Due is connected...
  AR_CHASSIS_SERIAL=$(udevadm info --query=property --name=/dev/arChassis | grep 'ID_SERIAL_SHORT')
  AR_CHASSIS_SERIAL=${AR_CHASSIS_SERIAL#*=}
  if [ $AR_CHASSIS_SERIAL == 'ARDUINO_DUE_SERIAL_NUMBER' ]; then
...
# Setup cameras
echo "$0 | step 3: setup cameras" # TODO: remove line when done

# ❯❯❯ TODO:fix ❯❯❯......................................................................................................
# Fix: handle setup cameras error case
...
echo "$0 | step 4: setup joystick" # TODO: remove line when done

# ❯❯❯ TODO:fix ❯❯❯......................................................................................................
# Problem: unreliable joystick/yoke recognition
...
#    export AR_JOYSTICK=
#done
export AR_JOYSTICK=/dev/input/js0 # Temp quick hack TODO:permanent solution
# ......................................................................................................❮❮❮ TODO:fix ❮❮❮


# ❯❯❯ TODO:fix ❯❯❯......................................................................................................
# Problem: command 'tput' cause error when called from a non interactive shell or when $TERM is not initialized
YELLOW=$(tput setaf 3)
RESET=$(tput sgr0)
